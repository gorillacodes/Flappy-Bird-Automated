...
os.chdir("C:/Users/Ahmar Ali Khan/Downloads/Talha/Tensor/Flappy Bird with AI")
...
STAT_FONT = pygame.font.SysFont("cambria", 40)
...
def draw_win(win, birds, pipes, base, score, gen, alive):
...
def main(genomes, config):
    ...
    while run:
        ...
        draw_win(win, birds, pipes, base, score, GEN, alive)
